...
/// <summary>
/// Makes sure that child processes are automatically terminated
...
internal sealed class ChildProcessTracer
{
    ...
    /// <summary>
    /// Adds a process to the tracking job. If the parent process is terminated,
    /// this process will also be automatically terminated.
    /// </summary>
